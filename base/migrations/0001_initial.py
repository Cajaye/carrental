# Generated by Django 4.1.6 on 2023-02-24 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(3000)])),
                ...
                ('status', models.CharField(choices=[('A', 'Available'), ('N/A', 'Not available')], default='A', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateField(auto_now=True)),
                ('created', models.DateField(auto_now_add=True)),
                ('cars', models.ManyToManyField(blank=True, related_name='cars', to='base.car')),
